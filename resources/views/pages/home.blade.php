...
<a href="{{ Route('add') }}">
    ...
    <table>
        ...
        @foreach ($data as $person)
                <tr>
                    <td>{{ $person->image }}</td>
                    <td>{{ $person->trailer }}</td>
                    <td>{{ $person->dsecription }}</td>
                    <td>{{ $person->rating }}</td>
                    <td>{{ $person->writtenBy }}</td>
                    <td>{{ $person->genre }}</td>
					<td>{{ $person->directedBy }}</td>
					<td>{{ $person->releaseDate }}</td>
                </tr>
            @endforeach
	    ...
	    <div class="popular_2i1 row">
		 <div class="col-md-4 col-4">
		  <div class="popular_2i1lm position-relative clearfix">
		   <div class="popular_2i1lm1 clearfix">
		      <div class="grid">
		  <figure class="effect-jazz mb-0">
			<a href="#"><video src="trailer1"></video></a>
		  </figure>
	  </div>
		   </div>
		   <div class="popular_2i1lm2 position-absolute top-0 w-100 text-center clearfix">
		 ...
		 <div class="col-md-8 col-8">
		  <div class="popular_2i1r">
		   ...
		   <p>Four waves of increasingly deadly alien attacks have left most of  ruin. Cassie is on the run, desperately trying to save her younger brother.</p>
		   <h6 class="mb-0"><a class="button" href="/booking"> Booking Now</a></h6>
		  </div>
		 </div>
		</div>
	   </div>
