 ...
 <div class="row top_1">
  <div class="col-md-3">
   <div class="top_1l pt-1">
    <h3 class="mb-0"><a class="text-white" href="/"><i class="fa fa-video-camera col_red me-1"></i> Planet</a></h3>
   </div>
  </div>
  <div class="col-md-5">
   <div class="top_1m">
      ...
      <ul class="navbar-nav mb-0">
		...
		<li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu drop_1" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item border-0" href="contact">Contact</a></li>
          </ul>
        </li>
